...
from classification.utils import CutMix, mixup_data
...
parser.add_argument('-lr', default=None, type=float, help='synthetic data dir')
...
eval_loader = DataLoader(test_set, batch_size=batch_size, shuffle=False, collate_fn=collate_fn, num_workers=num_workers)
...
shutil.copyfile('classification/train_hub.py', exp_dir + '/train_hub.py')
# save args to yaml
