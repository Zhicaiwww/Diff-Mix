...
def main():
    ...
    args.store_name = '_'.join(
        ['Z' ,args.dataset, args.arch, args.loss_type, 'lr', str(args.lr), args.train_rule, args.data_aug, str(args.imb_factor),
         ...
         str(args.mixup_prob),str(args.syn_type), str(args.synthetic_probability), str(args.soft_power),args.exp_str])
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    synthetic_dir = None if args.syn_type is None else parse_synthetic_dir(args.dataset, args.syn_type)
