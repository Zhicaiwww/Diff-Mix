...
def main(source_directory_list, target_directory, num_samples):
    ...
    # random sample idx
    random_indices = random.sample(range(len(image_files)), min(int(num_samples),len(image_files)))
...
if __name__ == '__main__':
    ...
    for syn in args.source_syn:
        source_directory = parse_synthetic_dir(args.dataset, syn)
        generate_meta_csv(source_directory)
        source_directory_list.append(source_directory)
