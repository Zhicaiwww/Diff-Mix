...
class PASCALDataset(FewShotDataset):
    ...
    class2label = {name: i for i, name in enumerate(class_names)}
    label2class = {i: name for i, name in enumerate(class_names)}
    ...
    def __init__(self, *args, split: str = "train", seed: int = 0, 
        ...
        super(PASCALDataset, self).__init__(
            *args, examples_per_class=examples_per_class,
            ...
            generative_aug=generative_aug, crop_size=crop_size, **kwargs)
...
class PASCALHugDataset(HugFewShotDataset):
    ...
    def __init__(self, *args, split: str = "train", seed: int = 0, 
        ...
        super(PASCALHugDataset, self).__init__(
            *args, examples_per_class=examples_per_class,
            synthetic_probability=synthetic_probability, image_size=image_size, 
            return_onehot=return_onehot, soft_scaler=soft_scaler,
            synthetic_dir=synthetic_dir,**kwargs)
...
if __name__ == '__main__':
    ds = PASCALHugDataset(split="train", examples_per_class=5, return_onehot=True, synthetic_dir='/data/zhicai/code/da-fusion/outputs/aug_samples/pascal-0-16')
    print(len(ds))