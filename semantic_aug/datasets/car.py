...
class CarHugDataset(HugFewShotDataset):
    ...
    def __init__(self, *args, split: str = "train", seed: int = 0, 
        ...
        super(CarHugDataset, self).__init__(
        ...
        if split == 'train':
            dataset = load_dataset('/data/zhicai/cache/huggingface/datasets/Multimodal-Fatima___stanford_cars_train',split='train')
        else:
            dataset = load_dataset('/data/zhicai/cache/huggingface/datasets/Multimodal-Fatima___stanford_cars_test',split='test')
...
class CarHugDatasetForT2I(torch.utils.data.Dataset):
