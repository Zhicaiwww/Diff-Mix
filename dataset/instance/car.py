        ...
        **kwargs,
        ...
        if split == "train":
            dataset = load_dataset(
                "/data/zhicai/cache/huggingface/datasets/Multimodal-Fatima___stanford_cars_train",
                split="train",
            )
        else:
            dataset = load_dataset(
                "/data/zhicai/cache/huggingface/datasets/Multimodal-Fatima___stanford_cars_test",
                split="test",
            )
