...
parser.add_argument('--dataset', default='cifar100', help='dataset setting', choices=('cifar100', 'Imagenet-LT', 'iNat18', 'cub', 'flower')
)
...
parser.add_argument('--syndata_key', default=None, type=str,)
parser.add_argument('--synthetic_probability', default=0.3, type=float,)
...
parser.add_argument('--soft_power', default=1, type=float,
                    help='momentum')
